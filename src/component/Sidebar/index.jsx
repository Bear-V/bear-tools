...
function GlobalSidebar() {
  ...
  const sidebar_list = [
    ...
    },
    {
      ...
      path: '/jsonTool',
      activeIndex: false,
      img: <svg className="w-5 h-5 fill-current text-black stroke-0" fill="none" stroke="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <div className="flex flex-col w-52 h-screen bg-gray-300">
        ...
        >
          {sidebarList.map((item, index) => {
            let className = "flex space-x-2 select-none mx-2 mt-1 pl-2 w-44 text-left text-sm rounded-r-full " +
        ...
        <div className="flex flex-col justify-center m-2">
          ...
          <div
            className="flex-1 text-sm text-gray-800 text-center select-none cursor-default">
